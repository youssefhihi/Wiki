...
<?php require APPROOT . '/views/inc/SideBar.php'; ?>
        ...
        <div class="p-8">
            <div class="flex flex-col gap-10">
                ...
                <h1 class=" text-black text-3xl">Wikis Tags</h1>
                <button onclick="AddTag()" class="px-4 py-2 border border-black bg-white text-black rounded-md hover:bg-black  hover:text-white">
                Add Tag
            </button>   
        </div>
